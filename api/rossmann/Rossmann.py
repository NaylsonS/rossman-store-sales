...
class Rossmann (object):
    def __init__(self):
        self.home_path='D:/Documentos/ESTUDOS/ComunidadeDS/repos/rossman-store-sales/'
    ...
    def data_cleaning (self, df1):
        ...
        cols_old = ['Store', 'DayOfWeek', 'Date', 'Open', 'Promo','StateHoliday', 'SchoolHoliday', 'StoreType', 
            ...
            'Promo2SinceWeek', 'Promo2SinceYear', 'PromoInterval'] # sem as colunas 'Sales', 'Customers'
